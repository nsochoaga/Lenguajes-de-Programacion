...
gramatica = {
    ...
    'SENTENCIAS':       [['id','ASIGID','EXPRE','SENTENCIAS'],
                        ...
                        ['leer','tk_parentesis_izquierdo','id','tk_parentesis_derecho','SENTENCIAS'],
                        ['epsilon']],
    ...
    'EXPRE':            [['tk_parentesis_izquierdo','EXPRE','tk_parentesis_derecho'],['tk_numero','EXPRE2'],['tk_cadena'],['id','EXPRE2']],
    'EXPRE2':           [['tk_suma','id'],['epsilon']],
